...
public class CopyShellCommand implements ShellCommand {
	...
	public ShellStatus executeCommand(Environment env, String arguments) {
		...
		Path filePath = env.getCurrentDirectory().resolve(Paths.get(argumentList.get(0)))
				.normalize();
		Path fileDirPath = env.getCurrentDirectory().resolve(Paths.get(argumentList.get(1)))
				.normalize();
