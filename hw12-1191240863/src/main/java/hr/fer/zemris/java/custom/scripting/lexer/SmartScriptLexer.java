...
public class SmartScriptLexer {
	...
	/** string of escapable characters in TEXT state */
	private final String textEscapable = "\\{";
	
	/** string of characters that are result of escaping textEscapables */
	private final String textTurnInto = "\\{";
	
	/** string that should terminate the TEXT token in TEXT state */
	private final String textStop = "{$";

	/** string of escapable character in STRING state */
	private final String stringEscapable = "\\\"nrt";
	
	/** string of character that are result of escaping stringEscapables */
	private final String stringTurnInto = "\\\"\n\r\t";
	
	/** string that should terminate the TEXT token in STRING state */
